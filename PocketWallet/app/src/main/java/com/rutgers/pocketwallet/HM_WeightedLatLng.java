 ...
 */
public class HM_WeightedLatLng implements PointQuadTree.Item {
     ...
     */
    public HM_WeightedLatLng(LatLng latLng, double intensity) {
    ...
    /**
     * Constructor that uses defaultlocation value for intensity
     *
     * @param latLng LatLng to add to wrapper
     */
    public HM_WeightedLatLng(LatLng latLng) {
