...
import com.rutgers.pocketwallet.interfaces.IDateMode;
import com.rutgers.pocketwallet.interfaces.IMainActivityListener;
import com.rutgers.pocketwallet.ui.categories.CategoriesFragment;
import com.rutgers.pocketwallet.ui.expenses.ExpensesContainerFragment;
import com.rutgers.pocketwallet.ui.expenses.MyDatabaseHelper;
import com.rutgers.pocketwallet.ui.reminders.ReminderFragment;
import com.rutgers.pocketwallet.ui.statistics.StatisticsFragment;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener, IMainActivityListener {
    ...
    public void initDatabase(){
        ...
        db = new MyDatabaseHelper(this, "contact.db", null, 1);
        double[] myLat = {40.5216, 40.4216, 40.5616, 40.5116, 40.5016, 40.4816,40.4815, 40.5031, 40.3616};
        double[] myLng = {-74.4715,-74.4615,-74.4515,-74.4515,-74.4515,-74.4415,-74.4515,-74.4615, -74.5655 };
        for(int i = 0; i < myLat.length; i++){
            dbWrite = db.getWritableDatabase();
            ContentValues cv = new ContentValues();
            cv.put("latitude", myLat[i]);
            cv.put("altitude", myLng[i]);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Toast.makeText(MainActivity.this, "setting function",  Toast.LENGTH_LONG).show();
            return true;
        } else if (id == R.id.action_help) {
            //startActivity(new Intent(this, HelpActivity.class));
            Toast.makeText(MainActivity.this, "help function",  Toast.LENGTH_LONG).show();
            return true;
        }
