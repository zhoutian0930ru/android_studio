...
public class ExpensesContainerFragment extends MainFragment implements ExpensesFragment.IExpenseContainerListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        expensesViewPagerAdapter.addFrag(ExpensesFragment.newInstance(IDateMode.MODE_TODAY), getString(R.string.expenses));
        //expensesViewPagerAdapter.addFrag(ExpensesFragment.newInstance(IDateMode.MODE_WEEK), getString(R.string.week));
        //expensesViewPagerAdapter.addFrag(ExpensesFragment.newInstance(IDateMode.MODE_MONTH), getString(R.string.expenses));
