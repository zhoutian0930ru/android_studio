...
public class HM_Gradient {
    ...
    /**
     * Creates a HM_Gradient with the given colors and starting points.
     ...
     */
    public HM_Gradient(int[] colors, float[] startPoints) {
        this(colors, startPoints, DEFAULT_COLOR_MAP_SIZE);
    }

    /**
     * Creates a HM_Gradient with the given colors and starting points which creates a colorMap of given size.
     * The colors and starting points are given as parallel arrays.
     *
     * @param colors       The colors to be used in the gradient
     * @param startPoints  The starting point for each color, given as a percentage of the maximum intensity
     *                     This is given as an array of floats with values in the interval [0,1]
     * @param colorMapSize The size of the colorMap to be generated by the HM_Gradient
     */
    public HM_Gradient(int[] colors, float[] startPoints, int colorMapSize) {
    ...
    private HashMap<Integer, ColorInterval> generateColorIntervals() {
        ...
        // The initial color is transparent by defaultlocation
        if (mStartPoints[0] != 0) {
