package com.rutgers.pocketwallet.ui.statistics;
...
public class StatisticsFragment extends MainFragment implements ISelectDateFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mMainActivityListener.setTitle("Analysis");
    ...
    private void setupCharts() {
        ...
        pcCategories.setCenterTextSize(30f);
        pcCategories.setHoleRadius(28f);
        pcCategories.setTransparentCircleRadius(31f);
    ...
    private void setCategoriesBarChart() {
        ...
        BarDataSet dataSet = new BarDataSet(entryPerCategory, "Item");
    ...
    private void setCategoriesPieChart() {
        ...
        PieDataSet dataSet = new PieDataSet(categoryPercentagesEntries, "Item");
